...
$sql = "SELECT * FROM schedual_tour WHERE user_id = $user_id  ORDER BY id DESC";
                          ...
                          <tr>  
                             <td><?php echo $row['Id']; ?></td>
                              ...
                              <td>
                                   ...
                                   <a href="Property_detail.php?Pro_id=<?php echo $row['Property_id'];?>" class="prev-btn"><i class="bi bi-eye"></i></a>
                                   </div>
                              </td>
