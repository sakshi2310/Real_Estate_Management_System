                          ...
                          <tr>  
                             <td><?php echo $row['Id']; ?></td>
                              ...
                              <td>
                                   ...
                                   <a href="Add_tour.php?tour_id=<?php echo $row['Id'];?>" class="prev-btn"><svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24"><path fill="currentColor" d="M5.455 15L1 18.5V3a1 1 0 0 1 1-1h15a1 1 0 0 1 1 1v12zm-.692-2H16V4H3v10.385zM8 17h10.237L20 18.385V8h1a1 1 0 0 1 1 1v13.5L17.546 19H9a1 1 0 0 1-1-1z"/></svg></a>
                                   </div>
                              </td>
