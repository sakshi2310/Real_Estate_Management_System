...
if(isset($_POST['submit']))
{
  ...
  $sql_images = "insert into website_aboutus_photo_gallery (Image ,Date) values ('$image',CURDATE())";
  $res_image = mysqli_query($con,$sql_images);
                    ...
                    <div class="row gy-4">
                            <div class="col-lg-5   col-md-6 col-12">
                                <div class="profile-pic position-relative d-flex flex-wrap align-items-center">
                                    ...
                                    <p class="ms-4 mb-0">Add Images For Image Gallery</p>
                                </div>
                            </div>
